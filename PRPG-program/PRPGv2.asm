andi_r3#r2 will hold seed values
#r1 holds memory address through the entire program, initialized to 0x2008

#the initial seed code goes here, will be different for each seed
half_lui 3       # has implicit register use, r3 = 3 << 4
addi_r0 15	       # r0 = 15
...
addi_r1 15
addi_r1 2   #move forward 17 bytes in memory
sw 2 1      #store r2 in that address
subi_r1 15
subi_r1 1   #memory update to next seed value, requires subtraction by 16
